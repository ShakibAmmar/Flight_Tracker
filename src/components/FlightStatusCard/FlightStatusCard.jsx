...
const handleClearAll = () => {
  ...
  // UPDATED: Corrected state setters and added Month sync
  useEffect(() => {
    if (prefilledData) {
      // 1. Fill Flight Info
      ...
      // 3. Handle Date (Corrected variable name to setSelectedDate)
      ...
      // 4. Set Tab (Corrected variable name to setSearchType)
